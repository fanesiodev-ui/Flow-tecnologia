...
// URL base da API — ajuste se o backend rodar em outra porta
...
async function gerarRelatorio() {
  ...
  formData.append("accountant_name", document.getElementById("accountantName").value || "Seu Contador");
  formData.append("company_name", document.getElementById("companyName").value || "Contabilidade Profissional");
...
async function gerarDemo() {
  ...
  formData.append("accountant_name", document.getElementById("accountantName").value || "Contabilidade Profissional");
  formData.append("company_name", document.getElementById("companyName").value || "Escritório Modelo");
  formData.append("primary_color", document.getElementById("primaryColor").value);
  formData.append("secondary_color", document.getElementById("secondaryColor").value);
...
function atualizarPreview() {
  ...
  document.getElementById("barPrimary").style.background = p;
  document.getElementById("barSecondary").style.background = s;
}

function sincronizarCor(tipo) {
  if (tipo === "primary") {
    const val = document.getElementById("primaryColorText").value;
    if (/^#[0-9A-Fa-f]{6}$/.test(val)) {
      document.getElementById("primaryColor").value = val;
      document.getElementById("previewPrimary").style.background = val;
      document.getElementById("barPrimary").style.background = val;
    }
  } else {
    const val = document.getElementById("secondaryColorText").value;
    if (/^#[0-9A-Fa-f]{6}$/.test(val)) {
      document.getElementById("secondaryColor").value = val;
      document.getElementById("previewSecondary").style.background = val;
      document.getElementById("barSecondary").style.background = val;
    }
  }
}
